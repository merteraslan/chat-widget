...
export function ChatWidget({
  ...
  const sendMessageWithText = useCallback(
    async (messageText: string) => {
      ...
      try {
        // Minimal retry: attempt twice on failures
            ...
            {messages.length === 0 ? (
              ...
              <>
                {messages.map((message) => {
                  ...
                  if (
                    message.interactive?.content_type === 'canned_response' ||
